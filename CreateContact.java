...
public class CreateContact {
	...
	public static void main(String[] args) {
		...
		WebDriverManager.chromedriver().setup();
	      ...
	      driver.findElement(By.id("firstNameField")).sendKeys("Praveen");
	      ...
	      driver.findElement(By.id("createContactForm_departmentName")).sendKeys("Testing department");
	      driver.findElement(By.id("createContactForm_description")).sendKeys("Grow With Test Leaf");
	      driver.findElement(By.id("createContactForm_primaryEmail")).sendKeys("praveen.vp93@gmail.com");
	      ...
	      driver.findElement(By.id("updateContactForm_importantNote")).sendKeys("Most important use of Test Leaf");
