...
public class EditLead {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		Thread.sleep(2000);
		driver.findElement(By.xpath("//label[text()='Lead ID:']//following::input[2]")).sendKeys("Praveen");
		...
		if(expectedTitle.equals(actualTitle))
			System.out.println("It is an expected Title");
		else
			System.out.println("It is not the same expected Title");
